...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-6">
            <h4 class="fw-bold py-3 mb-4"><span class="fw-light">Batches</h4>
        </div>
        <div class="col-6 text-right">
            <a href="javascript:void(0)" class="load-modal" title="Edit" data-url="{{ route('batch.add') }}">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-body col-md-12">
                    ...
                    <table id="batch_table" class="table table-md-8" data-url="{{ route('batch.list') }}">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Status</th>
...
@push('js')
<script src="{{ asset('assets/js/user/batch.js?t=' . config('app.t')) }}"></script>
@endpush