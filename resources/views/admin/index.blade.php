      ...
      <div class="col-lg-8 mb-4 order-0">
        <div class="card">
          <div class="d-flex align-items-end row">
            <div class="col-sm-7">
              <div class="card-body">
                <h5 class="card-title text-primary">Welcome {{Auth::user()->first_name}} 
                  {{Auth::user()->last_name}} ! 🎉</h5>
                <p class="mb-4">
                    Welcome to your Label management dashboard! Stay organized and manage your institution's academic programs with ease. Let us know if you need any assistance.
                </p>
